...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras()!=null) {
            LoginActivity.this.runOnUiThread(new Runnable() {
                public void run() {
                    Toast.makeText(LoginActivity.this, "wrong details", Toast.LENGTH_LONG);
                }
            });
        }
    }
    ...
    private void attemptLogin()
    {
       ...
       // Client myClient = new Client(MainActivity.ip, MainActivity.port, response);
        ...
        Client myClient = new Client("192.168.1.21", 8888, null, message);
        //myClient.getConnected();
        new AsyncTask<Void, Void, Void>() {
            @Override
            protected Void doInBackground(Void... params) {
                try {
                    Socket socket = new Socket("192.168.1.21", 8888);
                    if(message!=null)
                    {
                        try {
